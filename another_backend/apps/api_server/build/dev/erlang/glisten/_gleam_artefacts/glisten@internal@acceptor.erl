...
-type pool(JAG, JAH) :: {pool,
        fun((JAG, glisten@internal@handler:loop_message(JAH), glisten@internal@handler:connection(JAH)) -> glisten@internal@handler:next(JAG, glisten@internal@handler:loop_message(JAH))),
        integer(),
        fun((glisten@internal@handler:connection(JAH)) -> {JAG,
            gleam@option:option(gleam@erlang@process:selector(JAH))}),
        gleam@option:option(fun((JAG) -> nil)),
        glisten@transport:transport()}.
