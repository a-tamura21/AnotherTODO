...
?DOC(false).
-spec add_date_header(gleam@http@response:response(KSE)) -> gleam@http@response:response(KSE).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(KSH)) -> gleam@http@response:response(KSH).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(KSK)) -> gleam@http@response:response(KSK).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(KSN)) -> gleam@http@response:response(KSN).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(KSS)) -> gleam@http@response:response(KSS)).
