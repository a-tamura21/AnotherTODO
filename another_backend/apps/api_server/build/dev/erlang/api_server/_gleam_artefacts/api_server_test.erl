-module(api_server_test).
-compile([no_auto_import, nowarn_unused_vars, nowarn_unused_function, nowarn_nomatch]).
-define(FILEPATH, "test\\api_server_test.gleam").
-export([main/0, hello_world_test/0]).

-file("test\\api_server_test.gleam", 3).
-spec main() -> nil.
main() ->
    gleeunit:main().

-file("test\\api_server_test.gleam", 8).
